        ...
        <div class="row align-items-center">
            <div class="col-12 col-md-6 col-xl-7">
                <div class="d-flex justify-content-center text-bg-primary">
                    <div class="col-10">
                        <h1 class="text-black">Register<i class="fa-solid fa-user-plus ps-3"></i></h1>
                    ...
                    <div class="card-body p-3 p-md-4 p-xl-5">
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-4">
                                    <h3>Sign in</h3>
                                    <p>Already have an account?<a href="login.jsp" class="text-decoration-none ps-2">Sign
                                        in</a>
                                    </p>
                        ...
                        <form action="${pageContext.request.contextPath}/register?action=register" method="post"
                                ...
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="email" class="form-label"><i
                                                class="fa-solid fa-signature pe-3"></i>Ful name</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="email" class="form-label"><i
                                                class="fa-solid fa-envelope pe-3"></i>Email address</label>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="phno" id="phone"
                                               placeholder="" required>
                                        <label for="email" class="form-label"><i
                                                class="fa-solid fa-phone pe-3"></i>Phone number</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-floating mb-3">
