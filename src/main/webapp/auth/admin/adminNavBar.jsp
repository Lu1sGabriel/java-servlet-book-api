            ...
            <div class="btn-group" role="group">
                ...
                <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu" style="width: 100%;">
                        ...
                        <li><a class="dropdown-item" href="#"><i class="fa-solid fa-phone p-2"></i>Contact Us</a></li>
                        <li><a class="dropdown-item" href="${pageContext.request.contextPath}/auth/admin/admHome.jsp"><i class="fa-solid fa-screwdriver-wrench p-2"></i>Control panel</a></li>
                    </ul>
                </div>
            </div>
