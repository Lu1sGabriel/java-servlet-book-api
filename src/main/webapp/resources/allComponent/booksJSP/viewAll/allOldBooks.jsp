...
<div class="container mt-5">
    ...
    <div class="container text-center">
        <h1 class="px-2 mt-5">All Old Books</h1>
    </div>

    <div class="row m-3">

        <%
            BookDAOImplementation allOldBookDAO = new BookDAOImplementation();
            List<Book> allOldBooksList = allOldBookDAO.getAllOldBooks();
            for (Book allOldBookModel : allOldBooksList) {
        %>
        ...
        <div class="col-4">
            <div class="card mb-3" style="max-width: 440px;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="../../../book/<%=allOldBookModel.getPhoto()%>"
                    ...
                    <div class=" col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">
                                <%=allOldBookModel.getBookName()%>
                            </h5>
                            <p>
                                Category: <%=allOldBookModel.getBookCategory()%>
                            </p>
                            <h6 class="mb-2">
                                <%=allOldBookModel.getAuthor()%>
                            </h6>
                        </div>
