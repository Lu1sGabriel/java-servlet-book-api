        ...
        <div class="row align-items-center">
            <div class="col-12 col-md-6 col-xl-7">
                <div class="d-flex justify-content-center text-bg-primary">
                    <div class="col-10">
                        <h1 class="text-black">Login<i class="fa-solid fa-right-to-bracket ps-3"></i></h1>
                    ...
                    <div class="card-body p-3 p-md-4 p-xl-5">
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-4">
                                    <h3>Sign in</h3>
                                    <p>Don't have an account?<a href="register.jsp" class="text-decoration-none ps-2">Sign
                                        up</a>
                                    </p>
                                    ...
                                    <c:if test="${not empty sessionScope.failedMsg}">
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            <i class="fa-solid fa-triangle-exclamation pe-2"></i><strong class="pe-1">Holy
                                            guacamole!</strong>${sessionScope.failedMsg}
                                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                    aria-label="Close"></button>
                                        </div>
                        ...
                        <form action="${pageContext.request.contextPath}/register?action=login" method="post"
                            ...
                            <div class="row gy-3 overflow-hidden">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="email" class="form-label"><i
                                                class="fa-solid fa-envelope pe-3"></i>Email</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="password" class="form-label"><i
                                                class="fa-solid fa-key pe-3"></i>Password</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" name="remember_me"
                                               id="remember_me">
                                        <label class="form-check-label text-secondary mb-2" for="remember_me">
                                            Keep me logged in
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-grid">
                                        <button class="btn btn-primary btn-lg" type="submit">Login now</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <div class="row">
                            <div class="col-12">
                                <div
                                        class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-3">
